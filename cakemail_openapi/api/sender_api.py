...
class SenderApi(object):
    ...
    def confirm_sender(self, sender_id, confirm_sender, **kwargs):  # noqa: E501
        """Confirm a sender  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.confirm_sender(sender_id, confirm_sender, async_req=True)
        >>> result = thread.get()
        ...
        return self.confirm_sender_with_http_info(sender_id, confirm_sender, **kwargs)  # noqa: E501

    def confirm_sender_with_http_info(self, sender_id, confirm_sender, **kwargs):  # noqa: E501
        """Confirm a sender  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.confirm_sender_with_http_info(sender_id, confirm_sender, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('sender_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `sender_id` when calling `confirm_sender`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/brands/default/senders/{sender_id}/confirm-email', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
