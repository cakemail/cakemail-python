...
class Webhook(object):
    ...
    def actions(self, actions):
        ...
        :type: list[str]
        """
        allowed_values = ["all", "subscribe", "unsubscribe", "update", "delete", "spam", "bounce", "bounce_ac", "bounce_cr", "bounce_df", "bounce_fm", "bounce_hb", "bounce_mb", "bounce_sb", "bounce_tr"]  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
