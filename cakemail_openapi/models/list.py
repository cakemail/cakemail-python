...
class List(object):
    ...
    def __init__(self, name=None, default_sender=None, language='en_US', redirections=None, webhook=None, local_vars_configuration=None):  # noqa: E501
    ...
    def language(self):
        ...
        This will localize the tracking links and contents associated with that list.  # noqa: E501
