...
class CampaignContentResponse(object):
    ...
    def __init__(self, subject=None, html=None, text=None, hash=None, last_updated_on=None, encoding=None, default_unsubscribe_link=None, social_bar=None, footer=None, local_vars_configuration=None):  # noqa: E501
