...
class EmailLogResponse(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["clickthru", "open", "bounce", "bounce_ac", "bounce_cr", "bounce_df", "bounce_fm", "bounce_hb", "bounce_mb", "bounce_sb", "bounce_tr", "forward", "skipped", "spam", "subscribe", "unsubscribe", "view", "share", "in_queue", "generating", "received", "sent", "schedule", "other"]  # noqa: E501
