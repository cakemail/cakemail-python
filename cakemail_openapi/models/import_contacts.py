...
class ImportContacts(object):
    ...
    def __init__(self, import_to='active', contacts=None, local_vars_configuration=None):  # noqa: E501
    ...
    def import_to(self, import_to):
        ...
        :type: str
        """
        allowed_values = ["active", "unsubscribed", "deleted"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and import_to not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `import_to` ({0}), must be one of {1}"  # noqa: E501
                .format(import_to, allowed_values)
            )
